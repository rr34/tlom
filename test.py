...
# sqlstatements.misc_reports('2024-11-25', '2024-12-03')

# building = 'c'
# rooms_list = (311,312,314,203) # if single room number, requires a comma after
# item = 'access control' # not case-sensitive
# status = 'todo' # todo / complete / unmarked
# note = 'Needs handle only. Deadbolt installed and master-keyed.'
