...
sqlstatements.hours_report(['2024-10-28', '2024-11-11', '2024-11-25'], '2024-10-28')

# building = 'c'
# rooms_list = () # if single room number, requires a comma after
# item = 'Fire and CO Detectors' # not case-sensitive
# status = 'todo' # todo / complete / unmarked
# note = 'ePro going to quote changing the heads because causing alerts on system panel.'
